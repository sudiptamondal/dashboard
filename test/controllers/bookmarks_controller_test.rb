...
class BookmarksControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create bookmark" do
    assert_difference('Bookmark.count') do
      post bookmarks_url, params: { bookmark: { category_id: @bookmark.category_id, link: @bookmark.link, title: @bookmark.title } }
    end
  ...
  test "should update bookmark" do
    patch bookmark_url(@bookmark), params: { bookmark: { category_id: @bookmark.category_id, link: @bookmark.link, title: @bookmark.title } }
